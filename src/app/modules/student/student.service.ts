...
const updateStudent = async (
  ...
  if (name && Object.keys(name).length > 0) {
    Object.keys(name).forEach(key => {
      ...
      ;(updatedStudentData as any)[nameKey] = name[key as keyof typeof name] //name.firstName = 'jamal'
    })
  }
...
const deleteStudent = async (id: string): Promise<IStudent | null> => {
  //  1:student delete form student model 2. if student delete then must delete user from user model
